 ...
 * state, loading phases, visual errors, and mock execution triggers.
 */
export function useAuth() {
  ...
  const sendForgotPasswordReset = useAuthStore((state: CombinedStoreState) => state.sendForgotPasswordReset);
