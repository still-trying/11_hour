...
export const AUTH_ERROR_MESSAGES: Record<AuthErrorCode, string> = {
  ...
  [AuthErrorCode.INVALID_CREDENTIALS]:
    'Invalid email address or password. Please verify your credentials and try again.',
  [AuthErrorCode.WEAK_PASSWORD]:
    'Your password is too weak. It must be at least 8 characters long and include numbers and letters.',
  ...
  [AuthErrorCode.TOO_MANY_REQUESTS]:
    'Too many failed login attempts. Access has been temporarily restricted for security.',
  [AuthErrorCode.INVALID_EMAIL]: 'Please enter a valid, properly formatted email address.',
  [AuthErrorCode.OPERATION_NOT_ALLOWED]:
    'This sign-in method is currently disabled. Please contact system administrators.',
  [AuthErrorCode.USER_DISABLED]: 'This user account has been disabled. Please contact support.',
  [AuthErrorCode.UNKNOWN]:
    'An unexpected authentication error occurred. Our engineers have been alerted.',
};
