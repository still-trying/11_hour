...
export class AuthzErrorMapper {
  ...
  public static map(error: any, correlationId?: string): AuthorizationException {
    ...
    if (message.includes('unauthenticated') || message.includes('login') || message.includes('sign in')) {
      return new AuthorizationException(
   ...
   */
  public static createUnauthorized(message = 'User authentication is required to access this resource.', correlationId?: string): AuthorizationException {
    return new AuthorizationException(
      AuthzErrorCode.UNAUTHORIZED,
      message,
      correlationId
   ...
   */
  public static createForbidden(message = 'The authenticated user has insufficient permissions to perform this action.', correlationId?: string): AuthorizationException {
    return new AuthorizationException(
      AuthzErrorCode.FORBIDDEN,
      message,
      correlationId
