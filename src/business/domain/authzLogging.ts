...
export class AuthzLogger {
   ...
   */
  public static logGrant(path: string, context: IAuthorizationContext, decision: IAccessDecision): void {
    console.info(
   ...
   */
  public static logDeny(path: string, context: IAuthorizationContext, decision: IAccessDecision): void {
    console.warn(
   ...
   */
  public static error(message: string, error?: any, correlationId?: string): void {
