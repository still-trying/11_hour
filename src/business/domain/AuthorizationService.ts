...
import {
  ...
  authorizationRepositoryInstance,
...
import {
  ...
  AuthenticatedPolicy,
  RoleProtectedPolicy,
  PermissionProtectedPolicy,
  FeatureFlagProtectedPolicy,
...
export class AuthorizationService {
   ...
   */
  public async getAuthorizationContextForSession(
  ...
  public async evaluateRouteAccess(
    ...
    const decision = this.engine.checkAccess(
      policies,
      context,
