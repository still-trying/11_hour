...
export const signUpSchema = z.object({
  ...
  displayName: z
    ...
    .trim()
    .regex(/^[a-zA-Z0-9 _-]+$/, 'Display name can only contain alphanumeric characters, spaces, hyphens, or underscores'),
  password: z
    .string()
    .min(PASSWORD_CONSTRAINTS.MIN_LENGTH, `Password must be at least ${PASSWORD_CONSTRAINTS.MIN_LENGTH} characters long`)
